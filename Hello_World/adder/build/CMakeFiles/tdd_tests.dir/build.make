...
CMakeFiles/tdd_tests.dir/test/test_functions.cpp.o: ../test/test_functions.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/workspaces/tests/Hello_World/adder/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object CMakeFiles/tdd_tests.dir/test/test_functions.cpp.o"
	/usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/tdd_tests.dir/test/test_functions.cpp.o -c /workspaces/tests/Hello_World/adder/test/test_functions.cpp
...
CMakeFiles/tdd_tests.dir/test/test_functions.cpp.i: cmake_force
	...
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /workspaces/tests/Hello_World/adder/test/test_functions.cpp > CMakeFiles/tdd_tests.dir/test/test_functions.cpp.i
...
CMakeFiles/tdd_tests.dir/test/test_functions.cpp.s: cmake_force
	...
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /workspaces/tests/Hello_World/adder/test/test_functions.cpp -o CMakeFiles/tdd_tests.dir/test/test_functions.cpp.s
...
tdd_tests: CMakeFiles/tdd_tests.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/workspaces/tests/Hello_World/adder/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX executable tdd_tests"
	$(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/tdd_tests.dir/link.txt --verbose=$(VERBOSE)
	/usr/bin/cmake -D TEST_TARGET=tdd_tests -D TEST_EXECUTABLE=/workspaces/tests/Hello_World/adder/build/tdd_tests -D TEST_EXECUTOR= -D TEST_WORKING_DIR=/workspaces/tests/Hello_World/adder/build -D TEST_EXTRA_ARGS= -D TEST_PROPERTIES= -D TEST_PREFIX= -D TEST_SUFFIX= -D NO_PRETTY_TYPES=FALSE -D NO_PRETTY_VALUES=FALSE -D TEST_LIST=tdd_tests_TESTS -D CTEST_FILE=/workspaces/tests/Hello_World/adder/build/tdd_tests[1]_tests.cmake -D TEST_DISCOVERY_TIMEOUT=5 -P /usr/share/cmake-3.16/Modules/GoogleTestAddTests.cmake
